...
class CustomHopper(MujocoEnv, utils.EzPickle):
    def __init__(self, domain=None, random=False):
        ...
        self.random = random 
        if self.random:    
            # Define mass ranges for the thigh, leg, and foot links #TODO
            self.mass_ranges = {
                'thigh': (self.original_masses[1] - 1, self.original_masses[1] + 2),
                'leg': (self.original_masses[2] - 2, self.original_masses[2] + 1),
                'foot': (self.original_masses[3] - 2, self.original_masses[3] + 1),
            }
