...
class CustomHopper(MujocoEnv, utils.EzPickle):
    def __init__(self, domain=None, random=False):
        ...
        if self.random:    
            ...
            self.mass_ranges = {
                'thigh': (self.original_masses[1] - 1, self.original_masses[1] + 2),
                'leg': (self.original_masses[2] - 1.5, self.original_masses[2] + 1),
                'foot': (self.original_masses[3] - 1.5, self.original_masses[3] + 1),
            }
    ...
    def sample_parameters(self):
        ...
        # Implement domain randomization. Sample new dynamics parameter
